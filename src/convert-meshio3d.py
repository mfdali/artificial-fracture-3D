...
# Read gmsh file
mesh = meshio.read(msh_folder + msh_file + ".msh")
...
#Save mesh
meshio.write(msh_folder + msh_file + ".xdmf", tetra_mesh)

#Save boundaries
meshio.write(msh_folder + msh_file + "_boundaries.xdmf", triangle_mesh)