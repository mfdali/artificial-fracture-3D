# -----------------------------------------------------------------------------
#  
#  Create artificial fracture mesh based on Gmsh Python extended tutorial x2
#
#  Terrain meshing
#
# -----------------------------------------------------------------------------
...
mesh_name = "x2_slopev1_10N_2mm_meshsize_0003"
coords_file = "slope10N_coords"

min_meshsize = 0.0003
max_meshsize = 0.00035
lcmin = min_meshsize
lcmax = max_meshsize
lc = min_meshsize
...
random.seed(10)
Eq = "1E-4 * math.sin(10 * float(i+j) / 10*N) + 0.002 - ((10*float(i))/(10000*M))"
...
# Save coordinates to file to 2D simulation
np.savetxt(coords_file + '.csv', grid_coords , fmt="%.8e", delimiter=",")  
